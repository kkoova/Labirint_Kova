    ...
    public static class MazeBuilder
    {
        public static List<MazeBlocks> CreateMazeBlocks(int centerX, int centerY, int blockSize, int formWidth, int[,] visibleArea)
        {
            var mazeBlocks = new List<MazeBlocks>
            {
                ...
                new StaticSection(centerX, centerY, blockSize, formWidth, ColorMaze.OliveGreen, 4),
                ...
                new StaticSection(centerX, centerY, blockSize, formWidth, ColorMaze.OliveGreen, 5),
