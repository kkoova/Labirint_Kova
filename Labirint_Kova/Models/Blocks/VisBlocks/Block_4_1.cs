...
namespace Labirint_Kova.Models.Blocks.VisBlocks
{
    ...
    /// Блок [4, 1]
    /// </summary>
    internal class Block_4_1 : MazeBlocks
    {
        /// <summary>
        /// Инициализирует новый экземпляр класса <see cref="Block_4_1"/>.
        /// </summary>
        ...
        public Block_4_1(int centerX, int centerY, int blockSize, Color color, int type)
